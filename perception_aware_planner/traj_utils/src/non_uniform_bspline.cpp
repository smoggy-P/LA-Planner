...
void NonUniformBspline::getMeanAndMaxVel(double& mean_v, double& max_v, const double dur) {
...
void NonUniformBspline::getMeanAndMaxAcc(double& mean_a, double& max_a, const double dur) {
