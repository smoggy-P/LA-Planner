...
private:
  ...
  int allocate_num_, check_num_, initial_safe_ignore_limit_;
  double tie_breaker_;
  bool optimistic_;
...
public:
  ...
  int searchDebug(Eigen::Vector3d start_pt, Eigen::Vector3d start_vel, Eigen::Vector3d start_acc, Eigen::Vector3d end_pt,
      Eigen::Vector3d end_vel, bool init, bool dynamic = false, double time_start = -1.0);
